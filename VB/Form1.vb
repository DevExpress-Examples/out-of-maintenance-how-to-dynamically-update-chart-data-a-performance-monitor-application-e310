...
Namespace ChartPerfMon
	Partial Public Class Form1
		...
		Private Sub InitializeChart()
			...
			' Adjust time axis
			CType(chartControl1.Diagram, XYDiagram).AxisX.DateTimeScaleOptions.MeasureUnit = DateTimeMeasureUnit.Millisecond
			CType(chartControl1.Diagram, XYDiagram).AxisX.Label.DateTimeOptions.Format = DateTimeFormat.LongTime
			CType(chartControl1.Diagram, XYDiagram).AxisX.DateTimeScaleOptions.GridAlignment = DateTimeGridAlignment.Millisecond
